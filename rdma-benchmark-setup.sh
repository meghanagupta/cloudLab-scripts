...
# Install packages
sudo apt update
sudo apt --assume-yes install mosh vim tmux pdsh tree axel python3 python3-pip
sudo apt --assume-yes install linux-tools-common linux-tools-${kernel_release} hugepages cpuset msr-tools i7z
